...
Base = currículo real. Sem inventar formação/empresas. O envelope não anuncia “buscando vaga”.  
...
2. Featured: site + GitHub da automação.  
3. (Opcional) Open to Work só nas preferências do LinkedIn — não no headline.
