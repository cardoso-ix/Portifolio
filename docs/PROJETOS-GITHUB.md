...
| [linkedin-automacao-ia](https://github.com/cardoso-ix/linkedin-automacao-ia) | Post diário + replies a comentários | n8n · OpenRouter DeepSeek-V4-Flash · FLUX.2 Pro · LinkedIn | Perfil LinkedIn | Destaque |
...
- **O que é:** schedule diário 08:00 (America/Sao_Paulo); DeepSeek-V4-Flash gera texto; FLUX.2 Pro gera capa editorial (8 estilos, sem texto); fallback só texto; anti-dupe + Telegram. Em paralelo, poll ~2 min responde comentários com DeepSeek (Sheets + HTML → reply LinkedIn).
...
- **Card do site:** n8n · OpenRouter · DeepSeek · FLUX · LinkedIn.
